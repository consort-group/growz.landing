    ...
    <div class="sl-nav">
      <ul>
        <li>
          ...
          <ul>
            <li 
              v-for="(lang, idx) in props.langsData.data"
              :key="idx"
...
const currentLanguage = computed(() => {
  let locale = JSON.parse(localStorage.getItem('locale')) || 'en'
  let idx = props.langsData?.data?.findIndex(el => el.locale == locale)

  return props.langsData?.data?.[idx].name
})
